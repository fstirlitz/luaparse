...
(function (root, name, factory) {
  ...
  //
  // The passed tokens location will automatically be added to the error message
  // if it exists, if not it will default to the lexers current position.
  //
  // Example:
  //
  //     // [1:0] expected [ near (
  ...
  // character codes instead of characters as string comparisons was the biggest
  // bottleneck of the parser.
  //
  ...
  //
  // Slicing the input string is prefered before string concatenation in a loop
  ...
  function scanNumericLiteral() {
    ...
    if ('0' === char && ~'xX'.indexOf(next || null)) return scanHexLiteral();
    return scanDecLiteral();
  }
